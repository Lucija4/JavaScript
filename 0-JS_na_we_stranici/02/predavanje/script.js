...
const osobaNovo = `Ja sam ${ime}, ${trenutnaGod - godRodjenja}-godišnji ${zanimanje}.`;
...
//Možemo pomoću kombinacije floor i random metode, dodajemo + 1 jer želimo dobiti i 10, inače ćemo dobiti brojeve od 0 do 9
